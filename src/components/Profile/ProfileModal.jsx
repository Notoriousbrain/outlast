...
const ProfileModal = ({ profile, setProfileOpen }) => {
            ...
            <div className="flex flex-col gap-2 w-full">
                ...
                <div className=" w-full ">
                    <input
                        ...
                        value={name}
                        required={true}
                        onChange={(e) => setName( update ? e.target.value : profile?.name )}
                ...
                <div className=" w-full ">
                    <input
                        ...
                        value={phoneNumber}
                        onChange={(e) => setPhoneNumber( update ? e.target.value : profile?.number )}
                        className=" w-full outline-none placeholder:font-semibold h-full rounded-[30px] border border-border px-8 py-2"
                    />
                </div>
                <div className=" w-full ">
